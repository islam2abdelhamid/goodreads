...
const Authors = () => {
    ...
    const creation = ()=>{
      context.setAuthorObject({firstName:'', lastName:'', dateOfBirth: new Date()});
    ...
    return (
      <div className="col-10 m-auto">
        ...
        <i className="fas fa-plus-circle mb-3" title='Create new Author' type="button" onClick={creation} data-toggle="modal" data-target="#exampleModalCenter"></i>
